...
public final class EventSubscriptionGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<gen.Connect,
      gen.Connect> getConnectToServerMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "connectToServer",
      requestType = gen.Connect.class,
      responseType = gen.Connect.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<gen.Connect,
      gen.Connect> getConnectToServerMethod() {
    io.grpc.MethodDescriptor<gen.Connect, gen.Connect> getConnectToServerMethod;
    if ((getConnectToServerMethod = EventSubscriptionGrpc.getConnectToServerMethod) == null) {
      synchronized (EventSubscriptionGrpc.class) {
        if ((getConnectToServerMethod = EventSubscriptionGrpc.getConnectToServerMethod) == null) {
          EventSubscriptionGrpc.getConnectToServerMethod = getConnectToServerMethod = 
              io.grpc.MethodDescriptor.<gen.Connect, gen.Connect>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "tutorial.EventSubscription", "connectToServer"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  gen.Connect.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  gen.Connect.getDefaultInstance()))
                  .setSchemaDescriptor(new EventSubscriptionMethodDescriptorSupplier("connectToServer"))
                  .build();
          }
        }
     }
  ...
  public static abstract class EventSubscriptionImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void connectToServer(gen.Connect request,
        io.grpc.stub.StreamObserver<gen.Connect> responseObserver) {
  ...
  public static final class EventSubscriptionBlockingStub extends io.grpc.stub.AbstractStub<EventSubscriptionBlockingStub> {
    ...
    /**
     */
    public gen.Connect connectToServer(gen.Connect request) {
  ...
  public static final class EventSubscriptionFutureStub extends io.grpc.stub.AbstractStub<EventSubscriptionFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<gen.Connect> connectToServer(
        gen.Connect request) {
  ...
  private static final int METHODID_CONNECT_TO_SERVER = 1;
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_CONNECT_TO_SERVER:
          serviceImpl.connectToServer((gen.Connect) request,
              (io.grpc.stub.StreamObserver<gen.Connect>) responseObserver);
          break;
        default:
