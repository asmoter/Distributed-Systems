...
public class CurrencyController {
    ...
    public String convert(@RequestParam(name = "to") String to, @RequestParam(name = "base") String base, Model model) {
        ...
        if (to.equals(base)) {
            ...
            model.addAttribute("rng", 0); // range = max - min
        ...
        model.addAttribute("rng", stats.get("rng"));
    ...
    private Map<String, String> calculate(String base, String to){
        ...
        results.put("rng", String.valueOf(op.maximum(exchangeRates) - op.minimum(exchangeRates)));
